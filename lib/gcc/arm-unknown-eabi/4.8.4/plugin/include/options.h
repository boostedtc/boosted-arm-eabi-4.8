...
enum opt_code
{
  ...
  OPT_mneon_for_64bits = 1061,               /* -mneon-for-64bits */
  OPT_mpic_register_ = 1062,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1063,            /* -mpoke-function-name */
  OPT_mrestrict_it = 1064,                   /* -mrestrict-it */
